<x-app-layout>
    <div class="py-8">
        <div class="bg-white p-6 rounded-lg shadow-lg max-w-3xl mx-auto">
            ...
            <h2 class="text-lg font-bold mb-4">Tipos de Evento</h2>
                ...
                <tbody>
                    @foreach($tipoEvento as $tipo)
                        <tr>
                            ...
                            <td class="px-4 py-2">
                                <!-- Botón de Editar -->
                                <a href="{{ route('EditTipoEvento', ['id' => $tipo->id]) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 text-sm uppercase font-bold rounded">
                                    Editar
                                </a>

                                <!-- Botón de Eliminar -->
                                <form action="{{ route('DeleteTipoEvento', ['id' => $tipo->id]) }}" method="POST" class="inline-block ml-2">
                                    @csrf
                                    @method('DELETE')
