<x-app-layout>
    <div class="py-8">
        <div class="bg-white p-6 rounded-lg shadow-lg max-w-3xl mx-auto">
            <h2 class="text-lg font-bold mb-4">Editar Categoria de Material</h2>
            <form method="POST" action="{{ route('UpdateCategoriaMaterial',$categoriamaterial->id) }}">
                @csrf
                @method('PUT')
                <div class="mb-6">
                    <!-- Input -->
                    <div class="w-full mb-4">
                        ...
                        <x-input id="descripcion"
                                 ...
                                 type="text"
                                 name="descripcion"
                                 :value="old('descripcion',$categoriamaterial->descripcion)"
                                 required
                                 autofocus
